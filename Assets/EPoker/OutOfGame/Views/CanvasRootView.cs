namespace yigame.epoker {
    ...
    public class CanvasRootView : CanvasRootViewBase {
    ...
    public override void PanelCollectionAdded(uFrame.MVVM.ViewBase view) {
    }
    
    public override void PanelCollectionRemoved(uFrame.MVVM.ViewBase view) {
    }
    }
}
