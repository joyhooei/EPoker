...
public static class PhotonNetwork
{
	...
	/// <summary>
	/// Connects to master server with auth parameters.
	/// ethan edit
	/// </summary>
	/// <param name="id">Identifier.</param>
	/// <param name="ticket">Ticket.</param>
	public static void ConnectToMasterServerWithAuthParams (string playfabId, string ticket, string appId, string version)
	{	
		networkingPeer.SetApp (appId, version);
		if (networkingPeer.CustomAuthenticationValues == null) {
			networkingPeer.CustomAuthenticationValues = new AuthenticationValues () {
				AuthType = CustomAuthenticationType.Custom
			};
		} 
		networkingPeer.CustomAuthenticationValues.AddAuthParameter (playfabId, ticket);

//		networkingPeer.ConnectToRegionMaster (CloudRegionCode.asia);
